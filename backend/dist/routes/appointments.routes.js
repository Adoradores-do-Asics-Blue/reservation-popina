...
var CreateApppoitmentService_1 = __importDefault(require("../services/CreateApppoitmentService"));
var appointmentsRouter = express_1.Router();
appointmentsRouter.get('/', function (request, response) {
    var appointmentsRepository = typeorm_1.getCustomRepository(AppointmentsRepository_1.default);
    var appointments = appointmentsRepository.find();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                createAppointment = new CreateApppoitmentService_1.default();
